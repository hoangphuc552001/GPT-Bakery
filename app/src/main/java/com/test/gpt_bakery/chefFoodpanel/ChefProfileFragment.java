...
public class ChefProfileFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        emailcustomer=v.findViewById(R.id.emailchef);
        namecustomer=v.findViewById(R.id.namechef);
        mobilecustomer=v.findViewById(R.id.mobilechef);
        statecustomer=v.findViewById(R.id.statechef);
        citycustomer=v.findViewById(R.id.citychef);
        rspww=v.findViewById(R.id.rspwwchef);
        update=v.findViewById(R.id.updatedatachef);
        user=FirebaseAuth.getInstance().getCurrentUser();
        userRef=FirebaseDatabase.getInstance().getReference("Customer");
        logout=(Button)v.findViewById(R.id.signOutchef);
